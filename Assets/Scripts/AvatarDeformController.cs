...
public class AvatarDeformController{
	...
	public static void Deform(AvatarSize avatarSize){
		switch(avatarSize){
			...
			avatarDeformData.CopyValuesFromAnotherData(predefined_AvatarDeformData[0]);
			break;
			case AvatarSize.Fat:
			avatarDeformData.CopyValuesFromAnotherData(predefined_AvatarDeformData[1]);
			break;
			case AvatarSize.Strong:
			avatarDeformData.CopyValuesFromAnotherData(predefined_AvatarDeformData[2]);
			break;
			case AvatarSize.Thin:
			avatarDeformData.CopyValuesFromAnotherData(predefined_AvatarDeformData[3]);
			break;
			default:
				break;
		}
