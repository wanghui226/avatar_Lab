...
public class BoneNode : MonoBehaviour{
 ...
 /*   private void Update(){
        if (allBoneType == null||boneType == null||bipScale == null||bipPos == null){
            return;
        }
        else{
            BoneScale.ChangeBipChildrenNode(allBoneType,boneType,bipScale,bipPos);
            BoneScale.GetBip(bipScale,bipPos);
        }
    } */
}
